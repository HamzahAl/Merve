...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 19080207, [Github Repo](https://github.com/HamzahAl/Merve.git)
...
library(readr)
DSAS <- read_csv("/cloud/project/data/DSAS.csv")
...
ggplot(DSAS) + geom_point(aes(dogalgaz_boru_hasari , icme_suyu_boru_hasari))
```

```{r tell, echo=FALSE, fig.cap='İlçelerdeki Agir Hasarli Bina Sayisi'}
ggplot(DSAS) + geom_point(aes(agir_yarali_sayisi, ilce_adi))
```
